...
## 🚀 Cách Nhanh Nhất để Chạy Project (1 LỆNH DUY NHẤT!)

> **✨ New**: Project đã được optimize với Monorepo + Shared node_modules

### ⚡ ONE-COMMAND SETUP (Khuyến nghị nhất!) ⭐
...
# Chạy NGAY - Tự động setup mọi thứ!
.\run.ps1
```

**Chỉ vậy thôi! Script sẽ tự động:**
- ✅ Kiểm tra Node.js, npm, Docker
- ✅ Cài đặt dependencies (npm install)
- ✅ Tạo .env file với secure JWT secrets
